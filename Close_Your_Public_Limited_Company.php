...
<head>
    ...
    <title>ECOVISRKCA - Close Your Public Limited Company</title>
...
<body>
    ...
    <div class="align-items-center Private_Limited_CompanyBanner d-flex justify-content-around pageBanner">
        <div class="">
            <p class="mainHeading text-center text-light">Close Your Public Limited Company
            </p>
        </div>
        <!-- <img src="" alt=""> -->
    </div>
    ...
    <div class="row justify-content-center mb-5 ">
        ...
        <h1 class=" primaryHeading text-danger mb-3 mt-5">Close Your Public Limited Company</h1>
            <p class="normalText ">Sometimes due to certain situations, a public limited company needs to be wound up. There could be multiple reasons for this. These reasons are :</p>
        ...
        <h1 class=" primaryHeading text-danger mb-3">Documents Required for OPC Company Closure</h1>
            ...
            <ul class="pl-2">
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p><b>Incorporation Documents:</b> MoA/AoA, Certificate of Incorporation, PAN Card, and other registration certificates.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p><b>Details of Activities:</b> Details of the period of time the company has been operative and when the operations were discontinued.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p><b>Legal Liabilities:</b> A statement regarding any pending litigations involving the company.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p><b>NOC from Regulatory Bodies:</b> An NoC for closure of the company must be obtained from the Income Tax Department, SEBI, RBI, etc..</p>
                    </div>
                </li>
            </ul>
        </div>
