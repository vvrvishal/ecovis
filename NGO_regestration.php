...
<body>
    ...
    <div class="align-items-center Private_Limited_CompanyBanner d-flex justify-content-around pageBanner">
        <div class="">
            <p class="mainHeading text-center text-light">Non Governmental Organisation (NGO) Registration</p>
        </div>
        <!-- <img src="" alt=""> -->
    </div>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-8 col-md-10 border-bottom border-danger">
            <h1 class="mb-3 mt-5 primaryHeading text-danger">What is an NGO?</h1>
            <p class="normalText">A non-governmental organization (NGO) is a non-profit organisation that functions independently of government. NGOs are organized on community, national, and international levels to serve specific social or political purposes. They do not operate for monetary profit.</p>
            <p class="normalText">An NGO can be started in three ways: Public Trust Act of all states, Indian Societies Act, and Companies Act. In India, a Trust, Society, Sangathan, Sangh, Non-Profitable Company all fall under the umbrella term of NGO. Income tax exemption is available for all non-profit NGOs.</p>

            <h1 class="mb-3 mt-5 primaryHeading text-danger">Why should I register an NGO?</h1>
            <p class="normalText">The legal status of organizations makes sure they are accountable for all the funds and donations they collect.</p>

            <ul class="pl-2">
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>A registered NGO works in an organised manner. In an unregistered firm, funds received can be under anyone’s name and used for their own personal profit.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>An NGO is bound by the rules of society.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>A registered NGO has multiple tax benefits.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-8 col-md-10 ">
            <h1 class="mb-3 mt-5 primaryHeading text-danger">What is the process of registering an NGO?</h1>
            <p class="normalText">An NGO can be registered in the form of a Public Trust, Section 8 Company, or Society.</p>
        </div>
