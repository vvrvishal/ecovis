...
<body>
    ...
    <!-- career nammer  -->
    <div class="align-items-center careearBanner d-flex justify-content-around pageBanner">
        <div class="">
            <p class="mainHeading text-center text-light">Build your business horizon with Us
            </p>
        </div>
    </div>
