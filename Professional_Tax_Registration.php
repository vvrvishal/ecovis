...
<body>
    ...
    <div class="align-items-center Private_Limited_CompanyBanner d-flex justify-content-around pageBanner">
        <div class="">
            <p class="mainHeading text-center text-light">Professional Tax Registration</p>
        </div>
        <!-- <img src="" alt=""> -->
    </div>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-8 col-md-10">
            <h1 class="mb-3 mt-5 primaryHeading text-danger">What is Professional Tax?</h1>
            <p class="normalText">Professional tax is a state-level tax that applies to salaried employees and professionals, including chartered accountants, lawyers, and doctors.</p>
            <p class="normalText">Professional tax has to be paid compulsorily by every member of staff who is employed in any private firm operating in India. All business owners must register for professional tax and take up responsibility for deducting professional tax and paying for it.</p>

            <h1 class="mb-3 mt-5 primaryHeading text-danger">PROFESSIONAL TAX VARIATION WITH EACH STATE</h1>
            <p class="normalText">The rate of professional tax varies from state to state. The state governments which are levying state tax are West Bengal, Maharashtra, Karnataka, Kerala, Assam, Madhya Pradesh, Orissa, Tripura, Meghalaya, and Gujarat.</p>

            <h1 class="mb-3 mt-5 primaryHeading text-danger">PROFESSIONAL TAX FOR SELF-EMPLOYED</h1>
            <p class="normalText">Any professional who earns a regular monthly income must pay this tax. Even those offering professional freelance services must pay professional tax using a special form. They must first get a registration number and then pay their taxes in the corresponding banks using the number.</p>

            <h1 class="mb-3 mt-5 primaryHeading text-danger">EXEMPTION FROM PROFESSIONAL TAX PAYMENT</h1>
            <p class="normalText">The following individuals are exempted from professional tax:</p>

            <ul class="pl-2">
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P>Parents of children with a permanent disability or mental disability.</P>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P>Members of the armed forces, including members of auxiliary forces or reservists, serving in the state.</P>
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P>Individuals, over 65 years of age.</P>
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P> Physically challenged individuals.</P>
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P> Women exclusively engaged as agent under the Mahila Pradhan Kshetriya Bachat Yojana or Director of Small Savings.</P>
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P> Parents or guardians of individuals who are mentally challenged.</P>
                ...
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <P> Badli workers in the textile industry.</P>
            ...
            <h1 class="mb-3 mt-5 primaryHeading text-danger">Why should I pay Professional Tax?</h1>

            <ul class="pl-2">
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>It is required as per the rules and regulations of the country. Every employee is bound to make the professional tax payment and employers in many states of India are strictly bound to obtain the registration of professional tax. Post registration, they have to make the deductions and pay service taxes of all the employees who work under them.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Paying professional tax avoids penalties. Failure in professional tax registration results in huge penalties that keep building over time.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Ease of Compliance. professional tax registration and compliance is very easy. The registration procedures are not time consuming and the further proceedings are also easy.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>The amount of professional tax paid in a year can be claimed as deduction from salary.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="row justify-content-center ">
        <div class="col-lg-8 col-md-10 ">
            ...
            <h1 class="mb-3 mt-5 primaryHeading text-danger">Proofs required for Professional Tax Registration</h1>
            <ul class="pl-2">
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Certificate of Incorporation, including either MOA & AOA or LLP Agreement.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>PAN card of Company attested by the company director</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Address proof for the office along with a NOC from the owner</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Bank account of the company including bank statements and cancelled cheque.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Passport size photographs, address and ID proof from all the directors</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Statement of consent by the partners.</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Shop and establishment certificate</p>
                    </div>
                </li>
                <li class="mb-1">
                    <div class="d-flex">
                        <span class="pr-3 text-danger"><i style='font-size:13px' class='far'>&#xf192;</i></span>
                        <p>Salary register and attendance register</p>
                    </div>
                </li>
            </ul>
